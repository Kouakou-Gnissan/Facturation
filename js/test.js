...
class DevisManager {
    ...
    ajouterLigneArticle() {
        ...
        row.innerHTML = `
            <td>
                <input type="text" class="form-control description-input" placeholder="Description de l'article..." required>
            </td>
            <td>
                <input type="number" class="form-control quantity-input" min="1" value="1" required>
            </td>
            <td>
                <input type="number" class="form-control price-input" min="0" step="0.01" placeholder="0.00" required>
            </td>
            <td>
    ...
    async ImprimerDevis() {
        ...
        localStorage.setItem("formData", JSON.stringify(devisData));
